    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/reports/student_progress/*").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/reports/teacher_courses_overview/*").hasRole("ADMIN")
